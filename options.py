...
class Options:
    def __init__(self, isTrain):
        ...
        self.train['input_size'] = (416, 416)   # input size of the image
        ...
        self.test['patch_size'] = 416 if self.dataset == 'GlaS' else 208
        self.test['overlap'] = 208
        ...
        # --- post processing --- #
        self.post = dict()
        self.post['min_area'] = 1290 if self.dataset == 'GlaS' else 20  # minimum area for an object
        self.post['radius'] = 3 if self.dataset == 'GlaS' else 2
